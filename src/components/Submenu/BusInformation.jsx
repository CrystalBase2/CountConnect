...
function BusDriver() {
    ...
    return (
        <div className="submenu-container">
            ...
            <h2 className="table-title"><b>Bus Information</b></h2>
                        ...
                        <div className="modal">
                            ...
                            <form onSubmit={handleSave}>
                                ...
                                <TextField
                                    ...
                                    size="small"
                                    helperText="Only 4 digits are allowed"
                                /><br></br>
                                <TextField
                                    type="text"
                                    value={idNumber}
                                    label="Raspi ID Number"
                                ...
                                <TextField
                                    ...
                                    size="small"
                                    helperText="Only 2 digits are allowed"
                                />
