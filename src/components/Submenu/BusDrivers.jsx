...
import { MdMessage, MdEdit, MdDone } from "react-icons/md";
...
function BusDriver() {
  ...
  const handleSave = async (e) => {
    e.preventDefault();
    await addBusDriver(busRoute, busNumber, driverName, contactNumber);
    closeModal();
  };
  ...
  const isFormFilled = () => {
    return busRoute !== "" && busNumber !== "" && driverName !== "" && contactNumber !== "";
  };
